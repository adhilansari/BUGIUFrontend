...
function dt() {
  ...
  class t {
    ...
    runTask(s, i, o) {
      ...
      let g = s,
        { type: V, data: { isPeriodic: ee = !1, isRefreshable: Z = !1 } = {} } =
          s;
      ...
      try {
        ...
        let Q = s.state;
        if (Q !== q && Q !== X)
          if (V == z || ee || (Z && Q === k)) he && g._transitionTo(d, A, k);
          else {
    ...
    scheduleTask(s) {
      ...
      try {
        ...
        throw (
          (s._transitionTo(X, k, q), this._zoneDelegate.handleError(this, o), o)
        );
      }
      return (
    ...
    cancelTask(s) {
      ...
      if (!(s.state !== d && s.state !== A)) {
        ...
        try {
          ...
          throw (
            (s._transitionTo(X, x), this._zoneDelegate.handleError(this, i), i)
          );
        }
        return (
...
var nt = typeof WorkerGlobalScope < 'u' && self instanceof WorkerGlobalScope,
  ...
  Ye = function (e) {
    ...
    if (Be && a === pe && e.type === 'error') {
      let f = e;
      (c =
        t && t.call(this, f.message, f.filename, f.lineno, f.colno, f.error)),
      ...
      (function (c) {
        typeof a[c] == 'function'
          ...
          : Ae(Y[e].prototype, c, {
              set: function (f) {
                typeof f == 'function'
                  ? ((this[oe][c] = Ve(f, e + '.' + c)), fe(this[oe][c], f))
                  : (this[oe][c] = f);
              },
              get: function () {
                return this[oe][c];
...
function Pt(e, n, a, t) {
  let c = (t && t.add) || He,
    ...
    I = function (k, d, A) {
      ...
      typeof x == 'object' &&
        x.handleEvent &&
        ((k.callback = (y) => x.handleEvent(y)), (k.originalDelegate = x));
      let X;
      try {
        k.invoke(k, d, [A]);
      } catch (y) {
  ...
  function J(k, d) {
    ...
    let s = function (r) {
        if (!S.isExisting)
          return w.call(S.target, S.eventName, S.capture ? $ : U, S.options);
      },
      i = function (r) {
        if (!r.isRemoved) {
        ...
        if (r.allRemoved)
          return b.call(r.target, r.eventName, r.capture ? $ : U, r.options);
      },
      o = function (r) {
    ...
    let l = function (r, u, v, R, m = !1, O = !1) {
      return function () {
        ...
        if (Se && L === 'uncaughtException') return r.apply(this, arguments);
        let B = !1;
        ...
        if (Q) {
          for (let ie = 0; ie < Q.length; ie++)
            if (L === Q[ie])
              return de ? r.call(N, L, F, se) : r.apply(this, arguments);
        }
        ...
        if (ge) {
          if (((We = !0), X)) {
            for (let ie = 0; ie < ge.length; ie++) if (_e(ge[ie], F)) return;
          }
        } else ge = N[ze] = [];
        let we,
        ...
        if (u) {
          ...
          if (v) {
            ...
            if (O) {
              ...
              for (let F = 0; F < L.length; F++) {
                let B = L[F],
                  de = B.originalDelegate ? B.originalDelegate : B.callback;
        ...
        if (Ke(P[0])) {
          ...
          if ($) E[$] = U;
            ...
            J.refresh = function () {
              ...
              return (
                x === 'notScheduled'
                  ? ((U._state = 'scheduled'), A._updateTaskCount(U, 1))
                  : x === 'running' && (U._state = 'scheduling'),
                d.call(this)
              );
            };
          }
      ...
      (C) =>
        function (_, P) {
          ...
          Qe(I)
            ...
            H?.type ? H.cancelFn && H.zone.cancelTask(H) : C.apply(e, P);
        }
    ));
}
function Ct(e, n) {
...
function Nt(e) {
  e.__load_patch('legacy', (n) => {
    ...
    e.__load_patch('timers', (n) => {
      let a = 'set',
        t = 'clear';
      ye(n, a, t, 'Timeout'), ye(n, a, t, 'Interval'), ye(n, a, t, 'Immediate');
    }),
    ...
    e.__load_patch('XHR', (n, a) => {
      ...
      function C(_) {
        ...
        let x = ue(
            ...
            () =>
              function (w, b) {
                return (w[c] = b[2] == !1), (w[T] = b[1]), x.apply(w, b);
              }
          ),
          ...
          z = ue(
            ...
            () =>
              function (w, b) {
                if (a.current[y] === !0 || w[c]) return z.apply(w, b);
                {
                  let D = {
                      target: w,
                      url: w[T],
                    ...
                    K = Ge(X, d, D, k, A);
                  w && w[p] === !0 && !D.aborted && K.state === q && K.invoke();
                }
              }
          ),
          S = ue(
            ...
            () =>
              function (w, b) {
                ...
                if (D && typeof D.type == 'string') {
                  ...
                  D.zone.cancelTask(D);
                } else if (a.current[G] === !0) return S.apply(w, b);
              }
          );
      }
    }),
    e.__load_patch('geolocation', (n) => {
      n.navigator &&
        ...
        yt(n.navigator.geolocation, ['getCurrentPosition', 'watchPosition']);
    }),
    e.__load_patch('PromiseRejectionEvent', (n, a) => {
      function t(c) {
        return function (f) {
          lt(n, c).forEach((T) => {
            ...
            if (p) {
              let C = new p(c, { promise: f.promise, reason: f.rejection });
              T.invoke(C);
            }
          });
        };
      ...
      n.PromiseRejectionEvent &&
        ((a[j('unhandledPromiseRejectionHandler')] = t('unhandledrejection')),
    ...
    function M(h, l, r) {
      ...
      if (h[k] === y) {
        ...
        if (
          ...
          for (let m = 0; m < R.length; ) o(h, R[m++], R[m++], R[m++], R[m++]);
          if (R.length == 0 && l == S) {
            h[k] = w;
            let m = r;
            try {
...
` + r.stack
        ...
        () => {
          try {
            let O = h[d],
              N = !!r && A === r[A];
            N && ((r[x] = O), (r[X] = R));
            let L = l.run(m, void 0, N && m !== q && m !== J ? [] : [O]);
            M(r, !0, L);
          } catch (O) {
            M(r, !1, O);
          }
    ...
    class Z {
            ...
            r[N].then(
              ...
              (L) => {
                R.push(L),
                  u--,
                  u === 0 &&
                    ((v = !0), O(new ee(R, 'All promises were rejected')));
              }
            );
        });
      }
      ...
      static allSettled(l) {
        return (this && this.prototype instanceof Z ? this : Z).allWithCallback(
          l,
          {
      ...
      static allWithCallback(l, r) {
        ...
        for (let L of l) {
          ...
          try {
            L.then(
              (B) => {
                (N[F] = r ? r.thenCallback(B) : B), m--, m === 0 && u(N);
              },
              (B) => {
                r ? ((N[F] = r.errorCallback(B)), m--, m === 0 && u(N)) : v(B);
              }
            );
          } catch (B) {
            v(B);
      ...
      then(l, r) {
        ...
        let v = new u(V),
          R = a.current;
        return this[k] == y ? this[d].push(R, v, l, r) : o(this, R, v, l, r), v;
      }
      catch(l) {
        ...
        u[A] = A;
        let v = a.current;
        return this[k] == y ? this[d].push(v, u, l, l) : o(this, v, u, l, l), u;
      }
    }
    (Z.resolve = Z.resolve),
      (Z.reject = Z.reject),
        ...
        c.forEach(function (_) {
          ...
          try {
            if (I.hasOwnProperty(_)) {
              ...
              H && H.value
                ? ((H.value = e.wrapWithCurrentZone(H.value, P)),
