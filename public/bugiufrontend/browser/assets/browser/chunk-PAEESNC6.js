import { J as E, L as mt, a as he, c as dt } from './chunk-UGMI2HG6.js';
var _ = (function (n) {
    return (
      (n[(n.State = 0)] = 'State'),
...
function Ot(n, e, t = new Map(), s = new Map()) {
  let i = [],
    r = [],
    o = -1,
    a = null;
...
function et(n, e, t, s) {
  switch (e) {
    case 'start':
      n.onStart(() => s(t && Me(t, 'start', n)));
      break;
    case 'done':
      n.onDone(() => s(t && Me(t, 'done', n)));
      break;
    case 'destroy':
      n.onDestroy(() => s(t && Me(t, 'destroy', n)));
      break;
  }
}
function Me(n, e, t) {
...
var As = typeof document > 'u' ? null : document.documentElement;
function st(n) {
...
var Y = null,
  _t = !1;
function Ns(n) {
  Y || ((Y = Ms() || {}), (_t = Y.style ? 'WebkitAppearance' in Y.style : !1));
  let e = !0;
  return (
    Y.style &&
      !Ds(n) &&
      ...
      !e &&
        _t &&
        (e = 'Webkit' + n.charAt(0).toUpperCase() + n.slice(1) in Y.style)),
    e
  );
}
function bi(n) {
...
var Kt = (() => {
    class n {
      ...
      static {
        this.ɵprov = mt({ token: n, factory: n.ɵfac });
      }
    }
    return n;
  })(),
...
function _e(n, e, t) {
  return n.hasOwnProperty('duration') ? n : Fs(n, e, t);
}
function Fs(n, e, t) {
  let s =
  ...
  if (typeof n == 'string') {
    let a = n.match(s);
    if (a === null) return e.push(gt(n)), { duration: 0, delay: 0, easing: '' };
    i = qe(parseFloat(a[1]), a[2]);
    let l = a[3];
    l != null && (r = qe(parseFloat(l), a[4]));
    let h = a[5];
    h && (o = h);
  } else i = n;
  if (!t) {
...
function ie(n) {
  return Array.isArray(n) ? (n.length == 1 ? n[0] : pt(n)) : n;
}
function Os(n, e, t) {
  let s = e.params || {},
    i = zt(n);
  i.length &&
    i.forEach((r) => {
      s.hasOwnProperty(r) || t.push(Ht(r));
    });
}
var ze = new RegExp(`${qt}\\s*(.+?)\\s*${ks}`, 'g');
function zt(n) {
  let e = [];
  if (typeof n == 'string') {
    let t;
    for (; (t = ze.exec(n)); ) e.push(t[1]);
    ze.lastIndex = 0;
  }
  return e;
}
function re(n, e, t) {
  let s = `${n}`,
    i = s.replace(ze, (r, o) => {
      let a = e[o];
      return a == null && (t.push(Yt(o)), (a = '')), a.toString();
    });
  return i == s ? n : i;
}
var Ls = /-+([a-z0-9])/g;
function nt(n) {
  return n.replace(Ls, (...e) => e[1].toUpperCase());
}
function Pi(n) {
...
function zs(n, e) {
  ...
  return (
    typeof n == 'string'
      ? n.split(/\s*,\s*/).forEach((s) => Bs(s, t, e))
      : t.push(n),
    t
  );
}
function Bs(n, e, t) {
  ...
  if (s == null || s.length < 4) return t.push(hs(n)), e;
  let i = s[1],
    r = s[2],
    o = s[3];
  e.push(Tt(i, o));
...
function Tt(n, e) {
  ...
  return (i, r) => {
    let o = n == Se || n == i,
      a = e == Se || e == r;
    return (
      !o && t && typeof i == 'boolean' && (o = i ? fe.has(n) : de.has(n)),
      !a && s && typeof r == 'boolean' && (a = r ? fe.has(e) : de.has(e)),
      o && a
    );
  };
}
var Bt = ':self',
  $s = new RegExp(`s*${Bt}s*,?`, 'g');
function ot(n, e, t, s) {
  return new Qe(n).build(e, t, s);
}
var wt = '',
  Qe = class {
    constructor(e) {
    ...
    build(e, t, s) {
      let i = new $e(t);
      return this._resetContextStyleTimingState(i), R(this, ie(e), i);
    }
    _resetContextStyleTimingState(e) {
      (e.currentQuerySelector = wt),
        (e.collectedStyles = new Map()),
        e.collectedStyles.set(wt, new Map()),
        (e.currentTime = 0);
    }
    visitTrigger(e, t) {
      let s = (t.queryCount = 0),
        ...
        o = [];
      return (
        e.name.charAt(0) == '@' && t.errors.push(Zt()),
        e.definitions.forEach((a) => {
          if ((this._resetContextStyleTimingState(t), a.type == _.State)) {
            let l = a,
              h = l.name;
            h
              .toString()
    ...
    visitState(e, t) {
      ...
      if (s.containsDynamicStyles) {
        ...
        s.styles.forEach((a) => {
          ...
          r.size && t.errors.push(es(e.name, [...r.values()]));
      }
      return {
        type: _.State,
        name: e.name,
    ...
    visitTransition(e, t) {
      ...
      let s = R(this, ie(e.animation), t),
        i = zs(e.expr, t.errors);
      return {
        type: _.Transition,
        matchers: i,
        animation: s,
    ...
    visitGroup(e, t) {
      ...
      return (
        (t.currentTime = i), { type: _.Group, steps: r, options: X(e.options) }
      );
    }
    visitAnimate(e, t) {
      let s = Ws(e.timings, t.errors);
      t.currentAnimateTimings = s;
      let i,
        r = e.styles ? e.styles : Ne({});
      if (r.type == _.Keyframes) i = this.visitKeyframes(r, t);
        ...
        if (!o) {
          a = !0;
          let h = {};
          s.easing && (h.easing = s.easing), (o = Ne(h));
        }
            ...
            o.forEach((a, l) => {
              ...
              c &&
                (r != i &&
                  r >= c.startTime &&
                  i <= c.endTime &&
                  (t.errors.push(ss(l, c.startTime, c.endTime, r, i)),
                  (u = !1)),
                (r = c.startTime)),
                u && h.set(l, { startTime: r, endTime: i }),
                t.options && Os(a, t.options, t.errors);
            });
        });
    }
    visitKeyframes(e, t) {
      let s = { type: _.Keyframes, styles: [], options: null };
      if (!t.currentAnimateTimings) return t.errors.push(is()), s;
      let i = 1,
        r = 0,
        o = [],
        a = !1,
        ...
        c = e.steps.map((b) => {
          let P = this._makeStyleAst(b, t),
            M = P.offset != null ? P.offset : js(P.styles),
            D = 0;
          return (
            M != null && (r++, (D = P.offset = M)),
            (l = l || D < 0 || D > 1),
            (a = a || D < h),
            (h = D),
            o.push(D),
      ...
      l && t.errors.push(ns()), a && t.errors.push(rs());
      let u = e.steps.length,
        S = 0;
      r > 0 && r < u ? t.errors.push(os()) : r == 0 && (S = i / (u - 1));
      let y = u - 1,
        d = t.currentTime,
    ...
    visitReference(e, t) {
      return {
        type: _.Reference,
        animation: R(this, ie(e.animation), t),
        options: X(e.options),
      };
    }
    visitAnimateChild(e, t) {
      return t.depCount++, { type: _.AnimateChild, options: X(e.options) };
    }
    visitAnimateRef(e, t) {
      return {
        type: _.AnimateRef,
    ...
    visitStagger(e, t) {
      t.currentQuery || t.errors.push(as());
      let s =
        e.timings === 'full'
...
function Ws(n, e) {
  ...
  let i = _e(t, e);
  return Ce(i.duration, i.delay, i.easing);
}
function X(n) {
  return (
    n ? ((n = he({}, n)), n.params && (n.params = Us(n.params))) : (n = {}), n
  );
}
function Ce(n, e, t) {
  return { duration: n, delay: e, easing: t };
}
function at(n, e, t, s, i, r, o = null, a = !1) {
  return {
    type: 1,
    element: n,
    keyframes: e,
...
var te = class {
  ...
  Xs = ':leave',
  xs = new RegExp(Xs, 'g');
function lt(n, e, t, s, i, r = new Map(), o = new Map(), a, l, h = []) {
  return new Ve().buildKeyframes(n, e, t, s, i, r, o, a, l, h);
}
var Ve = class {
    buildKeyframes(e, t, s, i, r, o, a, l, h, c = []) {
      h = h || new te();
      let u = new Ue(e, t, h, i, r, c, []);
      u.options = l;
    ...
    _applyAnimationRefDelays(e, t, s) {
      for (let i of e) {
        ...
        if (r) {
          let o =
            typeof r == 'number' ? r : $(re(r, i?.params ?? {}, t.errors));
          s.delayNextStep(o);
        }
      }
    }
    ...
    visitSequence(e, t) {
      ...
      if (
        ...
        i.previousNode.type == _.Style &&
          (i.currentTimeline.snapshotCurrentStyles(), (i.previousNode = Ee));
        let o = $(r.delay);
        i.delayNextStep(o);
      }
      e.steps.length &&
    ...
    visitQuery(e, t) {
      ...
      r &&
        ...
        (t.currentTimeline.snapshotCurrentStyles(), (t.previousNode = Ee));
      let o = s,
        a = t.invokeQuery(
          e.selector,
          e.originalSelector,
  ...
  Ue = class n {
    constructor(e, t, s, i, r, o, a, l) {
      (this._driver = e),
        ...
        (this.currentTimeline = l || new ve(this._driver, t, 0)),
      ...
      if (r) {
        ...
        o || (o = this.options.params = {}),
          Object.keys(r).forEach((a) => {
            (!t || !o.hasOwnProperty(a)) && (o[a] = re(r[a], o, this.errors));
          });
      }
    }
    _copyOptions() {
    ...
    invokeQuery(e, t, s, i, r, o) {
      ...
      if ((i && a.push(this.element), e.length > 0)) {
        (e = e.replace(Ys, '.' + this._enterClassName)),
          (e = e.replace(xs, '.' + this._leaveClassName));
        let l = s != 1,
          h = this._driver.query(this.element, e, l);
        s !== 0 &&
          (h = s < 0 ? h.slice(h.length + s, h.length) : h.slice(0, s)),
          a.push(...h);
      }
      return !r && a.length == 0 && o.push(ls(t)), a;
    }
  },
  ve = class n {
    constructor(e, t, s, i) {
    ...
    setStyles(e, t, s, i) {
      ...
      let r = (i && i.params) || {},
        o = Zs(e, this._globalTimelineStyles);
      for (let [a, l] of o) {
        let h = re(l, r, s);
  ...
  je = class extends ve {
    ...
    buildKeyframes() {
      ...
      if (this._stretchStartingKeyframe && t) {
        ...
        let h = new Map(e[0]);
        h.set('offset', bt(a)), r.push(h);
        let c = e.length - 1;
        for (let u = 1; u <= c; u++) {
          let S = new Map(e[u]),
            y = S.get('offset'),
            d = t + y * s;
          S.set('offset', bt(d / o)), r.push(S);
        }
        (s = o), (t = 0), (i = ''), (e = r);
      }
      return at(
...
function Pt(n, e, t, s, i, r, o, a, l, h, c, u, S) {
  return {
    type: 0,
    element: n,
    triggerName: e,
...
var ke = {},
  Te = class {
    ...
    match(e, t, s, i) {
      return Js(this.ast.matchers, e, t, s, i);
    }
    buildStyles(e, t, s) {
    ...
    build(e, t, s, i, r, o, a, l, h, c) {
      let u = [],
        S = (this.ast.options && this.ast.options.params) || ke,
        y = (a && a.params) || ke,
        ...
        M = new Map(),
        D = i === 'void',
        Z = { params: Qt(g, S), delay: this.ast.options?.delay },
        q = c ? [] : lt(e, t, this.ast.animation, r, o, d, T, Z, h, u),
        C = 0;
      return (
        q.forEach((k) => {
        ...
        u.length
          ? Pt(t, this._triggerName, s, i, D, d, T, [], [], P, M, C, u)
          : (q.forEach((k) => {
              let W = k.element,
                J = O(P, W, new Set());
              k.preStyleProps.forEach((G) => J.add(G));
              let ht = O(M, W, new Set());
              k.postStyleProps.forEach((G) => ht.add(G)), W !== t && b.add(W);
            }),
            Pt(
              t,
              this._triggerName,
  ...
  constructor(e, t, s) {
    (this.name = e),
      ...
      t.states.forEach((i) => {
        ...
        this.states.set(i.name, new We(i.style, r, s));
      }),
      At(this.states, 'true', '1'),
      At(this.states, 'false', '0'),
      t.transitions.forEach((i) => {
        this.transitionFactories.push(new Te(e, i, this.states));
      }),
      (this.fallbackTransition = ti(e, this.states, this._normalizer));
  }
  get containsQueries() {
...
var si = new te(),
  He = class {
    ...
    register(e, t) {
      ...
      if (s.length) throw ps(s);
      i.length && void 0, this._animations.set(e, r);
    }
    _buildPlayer(e, t, s) {
      let i = e.element,
        r = Ot(this._normalizer, e.keyframes, t, s);
    ...
    listen(e, t, s, i) {
      let r = tt(t, '', '', '');
      return et(this._getPlayer(e), s, r, i), () => {};
    }
    command(e, t, s, i) {
      if (s == 'register') {
        this.register(e, i[0]);
  ...
  Ye = class {
    ...
    listen(e, t, s, i) {
      if (!this._triggers.has(t)) throw Ss(s, t);
      if (s == null || s.length == 0) throw Es(t);
      if (!ci(s)) throw vs(s, t);
      let r = O(this._elementListeners, e, []),
        o = { name: t, phase: s, callback: i };
      r.push(o);
      let a = O(this._engine.statesByElement, e, new Map());
      return (
        a.has(t) || (I(e, ce), I(e, ce + '-' + t), a.set(t, Re)),
        () => {
          ...
          o &&
            o.forEach((a) => {
              if (a.name == s.triggerName) {
                ...
                (l._data = e), et(s.player, a.phase, l, a.callback);
              }
            }),
            i.markedForDestroy
              ? this._engine.afterFlush(() => {
  ...
  Xe = class {
    ...
    markElementAsDisabled(e, t) {
      t
        ? this.disabledNodes.has(e) || (this.disabledNodes.add(e), I(e, Fe))
        : this.disabledNodes.has(e) &&
          (this.disabledNodes.delete(e), ee(e, Fe));
    }
    removeNode(e, t, s) {
      if (me(t)) {
    ...
    listen(e, t, s, i, r) {
      return me(t) ? this._fetchNamespace(e).listen(t, s, i, r) : () => {};
    }
    ...
    processLeaveNode(e) {
      ...
      e.classList?.contains(Fe) && this.markElementAsDisabled(e, !1),
        this.driver.query(e, ni, !0).forEach((s) => {
    ...
    _flushAnimations(e, t) {
      ...
      for (let f = 0; f < this.collectedLeaveElements.length; f++) {
        ...
        p &&
          ...
          b.add(m),
          p.hasAnimation
            ? this.driver.query(m, oi, !0).forEach((v) => b.add(v))
            : P.add(m));
      }
      let M = new Map(),
        D = Ct(S, Array.from(b));
      ...
      for (let f = this._namespaceList.length - 1; f >= 0; f--)
        this._namespaceList[f].drainQueuedTransitions(t).forEach((p) => {
          ...
          if ((Z.push(v), this.collectedEnterElements.length)) {
            ...
            if (N && N.setForMove) {
              if (
                ...
                let H = N.previousTriggersValues.get(p.triggerName),
                  L = this.statesByElement.get(p.element);
                if (L && L.has(p.triggerName)) {
                  let le = L.get(p.triggerName);
                  (le.value = H), L.set(p.triggerName, le);
                }
              }
              v.destroy();
              return;
          ...
          let ft = [];
          w.timelines.forEach((N) => {
            (N.stretchStartingKeyframe = !0),
              this.disabledNodes.has(N.element) || ft.push(N);
          }),
            (w.timelines = ft),
            s.append(A, w.timelines);
          let jt = { instruction: w, player: v, element: A };
          o.push(jt),
            w.queriedElements.forEach((N) => O(a, N, []).push(v)),
            w.preStyleProps.forEach((N, H) => {
              if (N.size) {
                let L = l.get(H);
                L || l.set(H, (L = new Set())),
                  N.forEach((le, De) => L.add(De));
              }
            }),
            w.postStyleProps.forEach((N, H) => {
              let L = h.get(H);
              L || h.set(H, (L = new Set())), N.forEach((le, De) => L.add(De));
            });
        });
      if (q.length) {
        let f = [];
        q.forEach((m) => {
          f.push(bs(m.triggerName, m.errors));
        }),
      ...
      o.forEach((f) => {
        ...
        s.has(m) &&
          (k.set(m, m),
          this._beforeAnimationBuild(f.player.namespaceId, f.instruction, C));
      }),
        i.forEach((f) => {
          let m = f.element;
      ...
      let W = T.filter((f) => kt(f, l, h)),
        J = new Map();
      Mt(J, this.driver, P, h, B).forEach((f) => {
        kt(f, l, h) && W.push(f);
      });
      let G = new Map();
      y.forEach((f, m) => {
        Mt(G, this.driver, new Set(f), l, ue);
      }),
        W.forEach((f) => {
          let m = J.get(f),
            p = G.get(f);
          J.set(f, new Map([...(m?.entries() ?? []), ...(p?.entries() ?? [])]));
        });
      let Ae = [],
        ut = [],
        ct = {};
      o.forEach((f) => {
        ...
        if (s.has(m)) {
          ...
          if ((p.setRealPlayer(z), A === ct)) Ae.push(p);
          else {
      ...
      for (let f = 0; f < T.length; f++) {
        ...
        if (a.size) {
          let z = a.get(m);
          z && z.length && v.push(...z);
          let F = this.driver.query(m, Ke, !0);
        ...
        A.length ? fi(this, m, A) : this.processLeaveNode(m);
      }
      return (
        (T.length = 0),
        Ae.forEach((f) => {
    ...
    _beforeAnimationBuild(e, t, s) {
      ...
      for (let l of t.timelines) {
        ...
        this._getPreviousPlayers(h, c, o, a, t.toState).forEach((y) => {
          ...
          d.beforeDestroy && d.beforeDestroy(), y.destroy(), u.push(y);
        });
      }
      x(r, t.fromStyles);
    }
    _buildAnimation(e, t, s, i, r, o) {
      let a = t.triggerName,
        ...
        S = t.timelines.map((d) => {
          ...
          c.add(g);
          let T = g[K];
          if (T && T.removedBeforeQueried) return new U(d.duration, d.delay);
          let b = g !== l,
            P = di((s.get(g) || ai).map((C) => C.getRealPlayer())).filter(
              (C) => {
                let k = C;
            ...
            M = r.get(g),
            D = o.get(g),
            Z = Ot(this._normalizer, d.keyframes, M, D),
      ...
      h.forEach((d) => {
        O(this.playersByQueriedElement, d.element, []).push(d),
          d.onDone(() => hi(this.playersByQueriedElement, d.element, d));
      }),
        c.forEach((d) => I(d, Et));
      let y = j(S);
      return (
        y.onDestroy(() => {
          c.forEach((d) => ee(d, Et)), Q(l, t.toStyles);
        }),
        u.forEach((d) => {
          O(i, d, []).push(y);
        }),
...
function Mt(n, e, t, s, i) {
  let r = [];
  t.forEach((l) => r.push(Nt(l)));
  let o = [];
  s.forEach((l, h) => {
    let c = new Map();
    l.forEach((u) => {
      let S = e.computeStyle(h, u, i);
      c.set(u, S), (!S || S.length == 0) && ((h[K] = li), o.push(h));
    }),
      n.set(h, c);
  });
  let a = 0;
  return t.forEach((l) => Nt(l, r[a++])), o;
}
function Ct(n, e) {
  let t = new Map();
...
function Vt(n, e) {
  for (let t = 0; t < n.length; t++) {
    let s = n[t];
    s instanceof se ? Vt(s.players, e) : e.push(s);
  }
}
function mi(n, e) {
  let t = Object.keys(n),
...
var we = class {
  constructor(e, t, s) {
    (this._driver = t),
      ...
      (this._triggerCache = {}),
      (this.onRemovalComplete = (i, r) => {}),
      (this._transitionEngine = new Xe(e.body, t, s)),
      (this._timelineEngine = new He(e.body, t, s)),
  ...
  registerTrigger(e, t, s, i, r) {
    ...
    if (!a) {
      ...
      if (l.length) throw ds(i, l);
      h.length && void 0,
        (a = ei(i, c, this._normalizer)),
...
function pi(n, e) {
  ...
  return (
    Array.isArray(e) && e.length
      ? ((t = Oe(e[0])), e.length > 1 && (s = Oe(e[e.length - 1])))
      : e instanceof Map && (t = Oe(e)),
    t || s ? new xe(n, t, s) : null
  );
}
var xe = class n {
  static {
  ...
  constructor(e, t, s) {
    (this._element = e),
      ...
      (this._endStyles = s),
      (this._state = 0);
    let i = n.initialStylesByElement.get(e);
    i || n.initialStylesByElement.set(e, (i = new Map())),
  ...
  destroy() {
    this.finish(),
      this._state < 3 &&
        ...
        this._startStyles &&
          (x(this._element, this._startStyles), (this._endStyles = null)),
        this._endStyles &&
...
var be = class {
    ...
    beforeDestroy() {
      ...
      this.hasStarted() &&
        this._finalKeyframe.forEach((s, i) => {
          i !== 'offset' && e.set(i, this._finished ? s : rt(this.element, i));
        }),
  ...
  Ze = class {
    ...
    animate(e, t, s, i, r, o = []) {
      ...
      r && (l.easing = r);
      let h = new Map(),
        c = o.filter((y) => y instanceof be);
      Is(s, i) &&
        c.forEach((y) => {
          y.currentSnapshot.forEach((d, g) => h.set(g, d));
        });
      let u = Rs(t).map((y) => new Map(y));
      u = Ks(e, u, h);
      let S = pi(e, u);
      return new be(e, u, l, S);
    }
  };
function Ai(n, e) {
  return n === 'noop'
    ? new we(e, new Kt(), new Ie())
    : new we(e, new Ze(), new Be());
}
var Ft = class {
    constructor(e, t) {
      this._driver = e;
      let s = [],
        i = [],
        r = ot(e, t, s, i);
      if (s.length) throw cs(s);
      i.length && void 0, (this._animationAst = r);
    }
    buildTimelines(e, t, s, i, r) {
      let o = Array.isArray(t) ? vt(t) : t,
        a = Array.isArray(s) ? vt(s) : s,
        l = [];
      r = r || new te();
      let h = lt(this._driver, e, this._animationAst, it, ge, o, a, i, r, l);
      if (l.length) throw fs(l);
      return h;
    }
  },
  pe = '@',
...
var Rt = class {
  ...
  createRenderer(e, t) {
    ...
    if (!e || !t?.data?.animation) {
      ...
      if (!c) {
        let u = () => h.delete(i);
        (c = new Pe(s, i, this.engine, u)), h.set(i, c);
      }
      return c;
    }
    let r = t.id,
    ...
    return t.data.animation.forEach(a), new Je(this, o, i, this.engine);
  }
  begin() {
...
export {
  St as AnimationDriver,
  Kt as NoopAnimationDriver,
  Ft as ɵAnimation,
  we as ɵAnimationEngine,
  Je as ɵAnimationRenderer,
  Rt as ɵAnimationRendererFactory,
  Le as ɵAnimationStyleNormalizer,
  Pe as ɵBaseAnimationRenderer,
  Ie as ɵNoopAnimationStyleNormalizer,
  Ze as ɵWebAnimationsDriver,
  be as ɵWebAnimationsPlayer,
  Be as ɵWebAnimationsStyleNormalizer,
  Is as ɵallowPreviousPlayerStylesMerge,
  Pi as ɵcamelCaseToDashCase,
  Lt as ɵcontainsElement,
  Ai as ɵcreateEngine,
  st as ɵgetParentElement,
  It as ɵinvokeQuery,
  Rs as ɵnormalizeKeyframes,
  Ns as ɵvalidateStyleProperty,
  bi as ɵvalidateWebAnimatableStyleProperty,
};
